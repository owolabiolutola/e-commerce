 ...
 //product details 3
document.querySelector("#mainproduct3").src=products[2].images; 
document.querySelector("#product7").src= products[2].images; 
document.querySelector("#product8").src= products[2].images; 
 document.querySelector("#product9").src= products[2].images; 
 ...
 document.querySelector("#name31").innerText = `${products[2].name}`; 


 
//productprice
document.querySelector("#price3").innerText = `${products[2].price}`; 