 ...
 //product details 4
document.querySelector("#mainproduct4").src=products[3].images; 
document.querySelector("#product10").src= products[3].images; 
document.querySelector("#product11").src= products[3].images; 
 document.querySelector("#product12").src= products[3].images; 
 ...
 document.querySelector("#name41").innerText = `${products[3].name}`; 


 
//productprice 4
document.querySelector("#price4").innerText = `${products[3].price}`; 