 ...
 //product details 2
document.querySelector("#mainproduct2").src=products[1].images; 
document.querySelector("#product4").src= products[1].images; 
document.querySelector("#product5").src= products[1].images; 
 document.querySelector("#product6").src= products[1].images; 
 ...
 document.querySelector("#name21").innerText = `${products[1].name}`; 